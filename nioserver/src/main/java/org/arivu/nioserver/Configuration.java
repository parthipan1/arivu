...
public final class Configuration {
	...
	static {
		...
		for(Entry<String, Object> e:proxies.entrySet()){
			...
			Method httpMethod = Method.valueOf(Ason.getStr(proxy, "method", null));
			...
			ProxyRequestPath prp = new ProxyRequestPath(name, proxy_pass,
					Ason.getStr(proxy, "location", null), httpMethod , null, null, false, header);
